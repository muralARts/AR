...
import {Home, Explorer, Exhibitions, Header, FooterNav} from './js/components/Index'
...
export default class App extends Component {
 ...
 viewMatcher(){
  switch (this.state.currentPage) {
    ...
    // case MAP:
    //   return <MapScreen />
    //added onPressFunc to return statement for explorer
    case EXPLORER:
      return <Explorer onPressFunc={this.onPress}/>
    case EXHIBITIONS:
